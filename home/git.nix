...

{
  programs.git = {
    ...
    # Personal scaffolding dropped into other people's repos — a flake for
    # a dev shell, a justfile for local tasks — kept out of their diffs.
    ...
    ignores = [ "flake.nix" "flake.lock" "justfile" ];
